...
const getBooksList = (data) => {
  return axios.get(
    API_URL + "/books?keyword=" + data.searchKey + "&authId=" + data.authorId,
    { headers: authHeader() }
  );
};

const deleteBook = (id) => {
  return axios(API_URL + "/book/" + id, {
    method: "delete",
    headers: authHeader(),
  });
};
...
const putBook = (_id, ISBN, name, author, category) => {
  return axios(API_URL + "/book/" + _id, {
    method: "put",
    headers: authHeader(),
    data: { ISBN, name, author, category },
  });
};

const favoriteBook = (_id, action) => {
  return axios(API_URL + "/book/favorite/" + _id, {
    method: "put",
    headers: authHeader(),
    data: { action },
  });
...
const uploadPic = (file) => {
  ...
  return axios(API_URL + "/upload/books", {
    method: "post",
    headers: authHeader(),
    data,
  });
